...
说明:
  ...
  * AWACY 全表与 caniplayonlinux 的 sitemap 会缓存到 ~/.cache/nonoka-game-compat/，
    默认 24 小时过期。
"""
...
UA = {"User-Agent": "nonoka-game-compat-probe/0.1"}
TIMEOUT = 25
...
CACHE_DIR = Path.home() / ".cache" / "nonoka-game-compat"
CACHE_TTL = 24 * 3600
