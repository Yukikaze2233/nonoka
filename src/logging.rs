...
pub fn init(paths: &HotaruPaths, cli_debug: bool) -> Result<LoggingGuard> {
    ...
    let targets = Targets::new()
        ...
        .with_target("hotaru", level)
        .with_target("hotaru::qq", qq_level(level, cli_debug, env_value.is_some()));
