...
pub fn init(paths: &NanokaPaths, cli_debug: bool) -> Result<LoggingGuard> {
    ...
    let targets = Targets::new()
        ...
        .with_target("nanoka", level)
        .with_target("nanoka::qq", qq_level(level, cli_debug, env_value.is_some()));
