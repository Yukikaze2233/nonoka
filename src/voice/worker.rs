//! `nonoka-voice` 进程主体:麦克风、唤醒、识别、提示音全部住在这里。
//!
...
pub fn runtime_config(config: &AppConfig, paths: &NonokaPaths) -> Result<VoiceRuntimeConfig> {
...
pub fn models_dir(paths: &NonokaPaths) -> std::path::PathBuf {
    std::env::var_os("NONOKA_VOICE_MODELS_DIR")
