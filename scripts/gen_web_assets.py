...
`pics/nonoka-logo.png` 是 1254×1254，WebUI 里却只在侧栏显示 38 px、登录页 64 px；
`pics/nonokawallpaper.png` 是 3344×1882，看板框最大 330×178 px。直接用原图等于
...
# (原图, 副本, 覆盖框, 实际显示尺寸们)
ASSETS = [
    ("pics/nonoka-logo.png", "web/assets/nonoka-logo.png", (256, 256), [(38, 38), (64, 64)]),
    (
        "pics/nonokawallpaper.png",
        "web/assets/nonokawallpaper.png",
        (1280, 720),
        [(330, 178), (660, 356)],
    ),
]
