(() => {
  ...
  function setSettingsView(view) {
    ...
    window.NonokaSettings?.onShow(selected);
  }
  ...
  function applyAdvancedConfig() {
    try {
      ...
      window.NonokaSettings?.remapApiQuotaSecrets(state.configDraft, parsed);
  ...
  function setConsolePanel(panel) {
    ...
    if (window.NonokaDash?.has(panel)) window.NonokaDash.open(panel);
  }
