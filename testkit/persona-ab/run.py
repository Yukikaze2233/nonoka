...
class Repl:
    ...
    def __init__(self, home: Path, log: Path):
        ...
        # 裸 nonoka 自②批起打印模式帮助退出;测具显式进普通模式。
...
def score_chat(reply: str) -> dict:
    """默认 Nonoka 人格显式规则的机械化子集(与 08-14 判据同源):
