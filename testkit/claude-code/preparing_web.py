...
tool.started。未配 WebUI 密码时 loopback 免登录。
    ...
    NONOKA_HOME=/tmp/nonoka-ccprep/home python3 testkit/claude-code/preparing_web.py
...
BIN = Path(os.environ.get("NONOKA_BIN", REPO / "target" / "debug" / "nonoka"))
HOME = os.environ.get("NONOKA_HOME", "/tmp/nonoka-ccprep/home")
PORT = int(os.environ.get("NONOKA_PROBE_PORT", "8400"))
BASE = f"http://127.0.0.1:{PORT}"
RUNTIME = os.environ.get("XDG_RUNTIME_DIR_PROBE", "/tmp/mx-ccprep")
ENV = dict(os.environ, NONOKA_HOME=HOME, XDG_RUNTIME_DIR=RUNTIME)
